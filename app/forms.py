...
AIRPORTS = [
    ...
    ('GDL', 'GDL - Guadalajara International Airport'),
    ...
    ('DPS', 'DPS - Ngurah Rai International Airport'),
    ...
    ('JNB', 'JNB - O.R. Tambo International Airport'),
    ('CPT', 'CPT - Cape Town International Airport'),
    ('GIG', 'GIG - Rio de Janeiro/Galeão International Airport'),
    ('SCL', 'SCL - Arturo Merino Benítez International Airport'),
    ('LIM', 'LIM - Jorge Chávez International Airport'),
    ('BOG', 'BOG - El Dorado International Airport'),
    ('YUL', 'YUL - Montréal-Pierre Elliott Trudeau International Airport'),
